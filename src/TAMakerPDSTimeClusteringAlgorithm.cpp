/**
 * @file TAMakerPDSTimeClusteringAlgorithm.cpp
 *
...
#include "triggeralgs/PDSTimeClustering/TAMakerPDSTimeClusteringAlgorithm.hpp"

#include "TRACE/trace.h"
#define TRACE_NAME "TAMakerPDSTimeClusteringAlgorithm"
...
void
TAMakerPDSTimeClusteringAlgorithm::process(const TriggerPrimitivePDS& input_tp, std::vector<TriggerActivityPDS>& output_ta)
{
...
void
TAMakerPDSTimeClusteringAlgorithm::configure(const nlohmann::json& config)
{
...
TriggerActivityPDS
TAMakerPDSTimeClusteringAlgorithm::construct_ta() const
{
...
REGISTER_TRIGGER_ACTIVITY_MAKER_PDS(TRACE_NAME, TAMakerPDSTimeClusteringAlgorithm)
