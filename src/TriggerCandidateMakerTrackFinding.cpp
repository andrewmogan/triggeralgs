/**
 * @file TriggerCandidateMakerTrackFinding.cpp
 *
...
#include "triggeralgs/TrackFinding/TriggerCandidateMakerTrackFinding.hpp"

#include "TRACE/trace.h"
#define TRACE_NAME "TriggerCandidateMakerTrackFindingPlugin"
...
void
TriggerCandidateMakerTrackFinding::operator()(const TriggerActivity& activity,
...
void
TriggerCandidateMakerTrackFinding::configure(const nlohmann::json& config)
{
  if (config.is_object()) {
...
TriggerCandidate
TriggerCandidateMakerTrackFinding::construct_tc() const
{
  ...
  tc.type = TriggerCandidate::Type::kTrackFinding;
  tc.algorithm = TriggerCandidate::Algorithm::kTrackFinding;
...
bool
TriggerCandidateMakerTrackFinding::check_adjacency() const
{
...
void
TriggerCandidateMakerTrackFinding::add_window_to_record(TAWindow window)
{
...
void
TriggerCandidateMakerTrackFinding::dump_window_record()
{
...
REGISTER_TRIGGER_CANDIDATE_MAKER(TRACE_NAME, TriggerCandidateMakerTrackFinding)
