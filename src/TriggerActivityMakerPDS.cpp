/**
 * @file TriggerActivityMakerPDS.cpp
 *
...
#include "triggeralgs/PDS/TriggerActivityMakerPDS.hpp"

#include "TRACE/trace.h"
#define TRACE_NAME "TriggerActivityMakerPDS"
...
void
TriggerActivityMakerPDS::operator()(const TriggerPrimitive& input_tp, std::vector<TriggerActivity>& output_ta)
{
  if ((m_primitive_count++) % m_prescale == 0)
  {

    TLOG() << "Emitting PDS Trigger Activity " << (m_primitive_count-1);
    ...
    ta.type = TriggerActivity::Type::kPDS;
    ta.algorithm = TriggerActivity::Algorithm::kPDS;
...
void
TriggerActivityMakerPDS::configure(const nlohmann::json &config)
{
